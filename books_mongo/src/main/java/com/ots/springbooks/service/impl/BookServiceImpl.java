...
public class BookServiceImpl implements BookService {
  ...
  public void getBookById() {
    ...
    UUID bookId = UUID.fromString(ioService.read());

    Optional<Book> book = bookRepository.findById(bookId.toString());
    if (book.isPresent()) {
  ...
  public void insertBook() {
    ...
    UUID genreId = UUID.fromString(ioService.read());

    Optional<Author> author = authorRepository.findById(authorId.toString());
    Optional<Genre> genre = genreRepository.findById(genreId.toString());
